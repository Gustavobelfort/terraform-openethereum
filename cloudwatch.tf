...
resource "aws_cloudwatch_metric_alarm" "disk" {
  count               = var.eth_count
  alarm_name          = "ethereum-${var.region}-${count.index + 1}-high-disk-usage"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  namespace           = "CWAgent"
  evaluation_periods  = "1"
...
resource "aws_cloudwatch_metric_alarm" "cpu" {
  count               = var.eth_count
  alarm_name          = "ethereum-${var.region}-${count.index + 1}-high-cpu-utilization"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "1"
...
resource "aws_cloudwatch_metric_alarm" "health" {
  count               = var.eth_count
  alarm_name          = "ethereum-${var.region}-${count.index + 1}-status-check"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "1"
